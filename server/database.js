...
class Database {
    ...
    static async patchSqlite() {
        ...
        if (version === this.latestVersion) {
            ...
            try {
                ...
                log.error("db", "Please submit a bug report if you still encounter the problem after restart: https://github.com/luucfr/uptime-sns/issues");
    ...
    static async patchSqlite2() {
        ...
        try {
            ...
            log.error("db", ex);
            log.error("db", "Start Uptime-Kuma failed due to issue patching the database");
            log.error("db", "Please submit the bug report if you still encounter the problem after restart: https://github.com/luucfr/uptime-sns/issues");
