 ...
 */
console.log("Welcome to SNS Uptime");
...
log.info("server", "SNS Uptime Version: " + checkVersion.version);
...
(async () => {
    ...
    app.get("/.well-known/change-password", async (_, response) => {
        response.redirect("https://github.com/SNS-SOLUTIONS/sns-uptime/wiki/Reset-Password-via-CLI");
    });
        ...
        socket.on("prepare2FA", async (currentPassword, callback) => {
            try {
                ...
                if (user.twofa_status === 0) {
                    ...
                    // Related issue: https://github.com/SNS-SOLUTIONS/sns-uptime/issues/486
        ...
        socket.on("setup", async (username, password, callback) => {
            try {
                ...
                if ((await R.knex("user").count("id as count").first()).count !== 0) {
                    throw new Error("SNS Uptime has been initialized. If you want to run setup again, please delete the database.");
                }
...
let unexpectedErrorHandler = (error, promise) => {
    ...
    console.error("If you keep encountering errors, please report to https://github.com/SNS-SOLUTIONS/sns-uptime/issues");
};
