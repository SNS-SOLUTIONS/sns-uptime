...
class Monitor extends BeanModel {
    ...
    async start(io) {
        ...
        const beat = async () => {
            ...
            // See https://github.com/SNS-SOLUTIONS/sns-uptime/pull/3961#issuecomment-1804149144
        ...
        const safeBeat = async () => {
            try {
                ...
                log.error("monitor", "Please report to https://github.com/SNS-SOLUTIONS/sns-uptime/issues");
