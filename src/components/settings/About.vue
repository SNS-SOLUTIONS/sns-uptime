<template>
    <div class="d-flex justify-content-center align-items-center">
        <div class="logo d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="fs-4 fw-bold">SNS Uptime</div>
            ...
            <div class="my-3 update-link"><a href="https://github.com/SNS-SOLUTIONS/sns-uptime/releases" target="_blank" rel="noopener">{{ $t("Check Update On GitHub") }}</a></div>
