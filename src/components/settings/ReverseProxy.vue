<template>
    <div>
        ...
        <div v-if="installed" class="mb-2">
            <div class="mb-4">
                ...
                <div class="form-text">
                    ...
                    <a href="https://github.com/luucfr/uptime-sns/wiki/Reverse-Proxy-with-Cloudflare-Tunnel" target="_blank">
                        https://github.com/luucfr/uptime-sns/wiki/Reverse-Proxy-with-Cloudflare-Tunnel
                    </a>
                </div>
            </div>
        ...
        <div>
            ...
            {{ $t("Please read") }} <a href="https://github.com/luucfr/uptime-sns/wiki/Reverse-Proxy" target="_blank">https://github.com/luucfr/uptime-sns/wiki/Reverse-Proxy</a>.
        </div>
