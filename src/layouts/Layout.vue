<template>
    <div :class="classes">
        <div v-if="! $root.socket.connected && ! $root.socket.firstConnect" class="lost-connection">
            <div class="container-fluid">
                ...
                <div v-if="$root.showReverseProxyGuide">
                    {{ $t("Using a Reverse Proxy?") }} <a href="https://github.com/SNS-SOLUTIONS/sns-uptime/wiki/Reverse-Proxy" target="_blank">{{ $t("Check how to config it for WebSocket") }}</a>
                </div>
            </div>
        </div>
        ...
        <header v-if="! $root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            ...
            <a v-if="hasNewVersion" target="_blank" href="https://github.com/SNS-SOLUTIONS/sns-uptime/releases" class="btn btn-info me-3">
                ...
                <li v-if="$root.loggedIn" class="nav-item">
                    <div class="dropdown dropdown-profile-pic">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="https://github.com/SNS-SOLUTIONS/sns-uptime/wiki" class="dropdown-item" target="_blank">
        ...
        <header v-else class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3">
            <router-link to="/dashboard" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4 title ms-2">SNS Uptime</span>
            </router-link>
        </header>
